# Fiche d'Observation - Tests Utilisateurs (s08 / e2-7)

**Testeur / Binôme** : Camarade de classe (non briefé sur le projet)
**Persona ciblé** : Maya (18 ans, étudiante pressée)
**Support testé** : Maquette visuelle retenue (Design Chaleureux)
...
- **Observation du comportement** :
  ...
  - Hésitation constatée : L'utilisateur a cherché du regard un bouton de validation « Valider » avant de comprendre que le filtrage était instantané.
- **Résultat & Analyse** : **RÉUSSI AVEC RÉSERVE**. La tâche est accomplie sans aide en moins de 3 secondes, mais l'absence d'un indicateur de mise à jour automatique a provoqué un léger temps d'arrêt.